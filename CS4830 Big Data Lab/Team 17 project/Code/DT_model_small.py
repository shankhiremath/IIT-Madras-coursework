...
# Saving the model
try:
	lr_model.save("gs://projbucket7/TFIDF_decision_tree_model_v1")
except:
	model = lr_model.stages[2]
	print(model)
	model.save("gs://projbucket7/TFIDF_decision_tree_model_v1")
...
print("Evaluating on training data using DT classifier:", lr_evaluator.evaluate(prediction_train))
...
print("Evaluating on Test data DT:", lr_evaluator.evaluate(prediction_test))
