#CASE NO. 3
#Input is 4 people at the 4 corners and one person in the middle of the 2D grid
...
u[:, 1:2, 0:1] = u_max
u[:, (ppl_length-1):ppl_length, 1] = u_max
u[:, 0:1, 8:9] = u_max
u[:, 8:9, (ppl_length-1):] = u_max
...
def plotdensitymap(u_k, k):
    ...
    plt.title(f"Case 3: Information density map at t = {k} iterations")
    plt.xlabel("x")
    plt.ylabel("y")
...
anim.save('/home/shashank/Shashank Hiremath/Sem 5 content/Transport phenomena/My CFA Stuff/Images/case3.gif', writer='imagemagick', fps=100)

plt.show()

plt.figure()
plt.plot(ppl_hist)
plt.title("The diffusion of information in Case 3")
...
plt.title("Histogram of I(x,y, maximum iteration) in Case 3")
